...
public class MainActivity extends AppCompatActivity {
    ...
    private void getDataFromAPI() {
        ...
        String url = "https://spreadsheets.google.com/feeds/list/1gRKOM9P7cdzUYeLzmG--5_7xI_HppAyX5zKs2Cj_TqE/od6/public/values?alt=json";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0; i<entryArray.length(); i++){
                        ...
                        String accessPoint = entryObj.getJSONObject("gsx$accesspoint").getString("$t");
                        String rssi = entryObj.getJSONObject("gsx$rssi").getString("$t");
                        userModalArrayList.add(new UserModal(accessPoint, rssi));
